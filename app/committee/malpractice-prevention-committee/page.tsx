    ...
    <div className="min-h-screen bg-[#f5f1e8]">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          {/* Fourth Set of Nested Bullet Points */}
            ...
            <table className="w-full border-collapse border border-gray-400">
              ...
              <tbody>
                ...
                <tr className="bg-white">
                  ...
                  <td className="border border-gray-400 px-6 py-4 text-center text-gray-700">Dr. I. Carolin Nimila</td>
                ...
                <tr className="bg-white">
                  ...
                  <td className="border border-gray-400 px-6 py-4 text-center text-gray-700">Mrs. P. Meenaprabha</td>
                  <td className="border border-gray-400 px-6 py-4 text-center text-gray-700">Assistant Professor</td>
                  <td className="border border-gray-400 px-6 py-4 text-center text-gray-700">Member</td>
                </tr>
                <tr className="bg-gray-50">
                  <td className="border border-gray-400 px-6 py-4 text-center text-gray-700">6</td>
                  <td className="border border-gray-400 px-6 py-4 text-center text-gray-700">Mrs. B. Vasuki</td>
                  <td className="border border-gray-400 px-6 py-4 text-center text-gray-700">Assistant Professor</td>
                  <td className="border border-gray-400 px-6 py-4 text-center text-gray-700">Member</td>
                </tr>
              </tbody>
