      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-4">
          <nav className="flex items-center text-sm text-gray-600">
            ...
            <ChevronRight className="w-4 h-4 mx-2" />
            <span className="text-gray-900 font-medium">Strategic plan for GC</span>
          </nav>
        </div>
      </div>

      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-10">Strategic plan for GC</h1>
            ...
            <div className="bg-white rounded-lg shadow-sm">
              <div className="p-8 lg:p-10">
                <div className="space-y-8">
                  <div>
                    <h2 className="text-3xl font-bold text-gray-900 mb-6">Guidance and Counseling (GC)</h2>
                  ...
                  <div>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        ...
                        <span className="text-gray-700">Establish a comprehensive counseling center with qualified professionals for academic and personal guidance</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-[#6B9E4E] mt-1 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-gray-700">Implement mentorship programs connecting students with faculty advisors and industry professionals</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-[#6B9E4E] mt-1 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-gray-700">Provide career counseling and placement support aligned with pharmaceutical industry needs</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-[#6B9E4E] mt-1 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-gray-700">Address mental health and stress management through workshops and individual counseling sessions</span>
                      </li>
                      <li className="flex items-start">
                        <svg className="w-5 h-5 text-[#6B9E4E] mt-1 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                        </svg>
                        <span className="text-gray-700">Develop peer support networks and student assistance programs</span>
                      </li>
                    </ul>
                  </div>

                  <div>
                    <h3 className="text-2xl font-bold text-gray-900 mb-4">Key Initiatives</h3>
                    <div className="space-y-4">
                      ...
                      <div className="bg-[#f5f0e8] p-6 rounded-lg">
                        <h4 className="text-lg font-semibold text-[#0F6B3E] mb-2">Career Development Services</h4>
                        <p className="text-gray-700 text-sm">Conducting career assessment, resume building workshops, interview preparation sessions, and organizing campus recruitment drives with leading pharmaceutical companies.</p>
                      </div>
                      <div className="bg-[#f5f0e8] p-6 rounded-lg">
                      ...
                      <table className="w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                          ...
                          <tr className="bg-gray-50">
                            ...
                            <td className="border border-gray-300 px-4 py-3">Expansion of services and integration with alumni network</td>
