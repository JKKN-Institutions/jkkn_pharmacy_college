    ...
    <div className="min-h-screen bg-[#F5F1E8] flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12 lg:py-16">
          ...
          {/* Subtitle */}
          <h2 className="text-xl lg:text-2xl font-semibold text-gray-700 mb-8">
          ...
          <div className="space-y-6 text-gray-700 leading-relaxed">
            ...
            <p className="text-justify">
              Validation of Excellence: The institution's recognition as "BAND-PROMISING" by ARIIA-2021 (Atal Ranking of Institutions on Innovation Achievements) further underscores its distinctiveness. This acknowledgment highlights the institution's efforts in promoting innovation and its impact on society.
            </p>

            {/* Celebrating Excellence List */}
            <div className="mt-6">
              <ul className="space-y-4 ml-4">
                <li className="text-gray-700">
                  <strong>Celebrating Excellence:</strong>
                  <br />
                ...
                <li className="text-gray-700">
                  Hariharan and Jeevika received the TamilNadu Student Innovators Award – 2019 and a fellowship of Rs. 1 Lakh.
                </li>
                <li className="text-gray-700">
                  The institution actively participated in the Sustainable Development Goals Hackathon.
                </li>
                <li className="text-gray-700">
            ...
            {/* Section Headers */}
            <h3 className="text-xl lg:text-2xl font-bold text-gray-700 mt-12 mb-4">
              IDENTITY OF THE INSTITUTION THROUGH IIC ACHIEVERS
            </h3>

            <h3 className="text-xl lg:text-2xl font-bold text-gray-700 mt-8 mb-4">
              INFORMATION ATTACHED UNDER LINKS
            </h3>
            ...
            <div className="space-y-6 mt-6">
              ...
              <div className="mt-6">
                <p className="text-gray-700 text-justify">
                  Their creative innovation, Natural – Immuno Boosting Masks, won them second prize, the Student Innovators title, and a cash incentive of Rs. 20,000. They presented their proposal on October 30, 2021, at the StartupMania proposal Contest, which was organized by Nativelead, TBI-KEC, CII, YI-Erode, and YUVA.
                </p>
              </div>
              ...
              <div className="mt-6">
                <p className="text-gray-700 text-justify">
                  AZUBMoMOwl9aNxSoH8OOnHCxRvH44juTaneU_L0_ZScfDdtM8DeHhDaNNaxG6fsYAlvNx8OHRVk6t7fTB29p
                </p>
              </div>

              <div className="mt-6">
                <p className="text-gray-700 text-justify">
                  Ghr1RHit8yYp83p3W29d2dvLnVTGO_n8vCThDYMQSYS0ju8&__tn__=*bH-R
                </p>
              </div>

              <div className="mt-6">
                <p className="text-gray-700 text-justify">
                  Mr. Hariharan, IV B.pharm was awarded the "First Runner-Up" in the Innovation competition at the Global Goals Hackathon Conducted By StartupTN Erode
                </p>
              </div>
              ...
              <div className="mt-6">
                <p className="text-gray-700 text-justify">
                  On May 30, 2020, the Tamil Nadu Student Innovators Award – 2019 will be presented together with a fellowship grant of Rs. 1 lakh.
                </p>
              </div>
              ...
              <div className="mt-6">
                <p className="text-gray-700 text-justify">
                  In collaboration with StartupTN Erode Regional Hub, Nativelead Foundation, and Hand in Hand Academy for Social Entrepreneurs, KKN Educational Institutions is hosting a one-day bootcamp titled "Sustainable Development Goals Hackathon" on May 27, 2023, from 9 AM to 6 PM.hello
                </p>
              </div>
