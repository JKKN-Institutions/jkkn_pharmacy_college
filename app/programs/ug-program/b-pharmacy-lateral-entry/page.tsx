...
export default function BPharmLateralEntryPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-[#0B6E89] to-[#0BA5C9] text-white py-16 px-6 lg:px-8">
      ...
      <div className="bg-gradient-to-r from-[#0B6E89] to-[#0BA5C9] text-white py-16 px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="border-t-4 border-[#FF5733] bg-white shadow-lg rounded-lg overflow-hidden">
              <div className="p-8">
                ...
                <div className="flex justify-center mb-6">
                  <span className="bg-[#FF5733] text-white px-6 py-2 rounded-full font-semibold">
        ...
        <div className="mb-16">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse bg-white shadow-lg rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-gradient-to-r from-[#0B6E89] to-[#0BA5C9] text-white">
        ...
        <div className="bg-gradient-to-r from-[#0B6E89] to-[#0BA5C9] text-white py-16 px-8 rounded-lg mb-16">
        ...
        <div className="mb-16">
          ...
          {/* Documents Required */}
          <div className="bg-[#D1FAE5] border-l-4 border-[#10B981] p-8 rounded-r-lg">
            <div className="flex items-center gap-2 mb-6">
              <span className="text-2xl">📄</span>
        ...
        <div className="mb-16">
          ...
          {/* Choose B.Pharm If */}
          <div className="bg-[#D1FAE5] border-l-4 border-[#10B981] p-8 rounded-r-lg mb-6">
            <div className="flex items-center gap-2 mb-6">
              <span className="text-2xl">✅</span>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-start gap-4 mb-4">
                <div className="flex-shrink-0 w-10 h-10 bg-[#FF5733] text-white rounded-full flex items-center justify-center font-bold">
                  Q
                </div>
        ...
        {/* CTA Banner */}
        <div className="bg-gradient-to-r from-[#0B6E89] to-[#0BA5C9] text-white py-16 px-8 rounded-lg mb-16 text-center">
          ...
          <button className="bg-[#FF5733] hover:bg-[#E64A2E] text-white font-bold text-lg px-8 py-4 rounded-full transition-colors">
