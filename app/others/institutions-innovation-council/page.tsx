...
export default function InstitutionsInnovationCouncilPage() {
  return (
    <div className="min-h-screen bg-[#f5f1e8]">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">The objective of the council</h2>
        ...
        {/* The function of IIC */}
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">The function of IIC</h2>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start">
              <span className="mr-3 mt-1.5 w-1.5 h-1.5 bg-gray-700 rounded-full flex-shrink-0"></span>
              <span>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Innovation Ambassador Training Program</h2>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start">
              <span className="mr-3 mt-1.5 w-1.5 h-1.5 bg-gray-700 rounded-full flex-shrink-0"></span>
              <span>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">YUKTI Innovation Repository</h2>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start">
              <span className="mr-3 mt-1.5 w-1.5 h-1.5 bg-gray-700 rounded-full flex-shrink-0"></span>
              <span>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">National Innovation and Startup Policy (NISP) Committee</h2>
            ...
            <table className="w-full border-collapse border border-gray-400 bg-white">
              <thead>
                <tr className="bg-[#f5f1e8]">
                  <th colSpan={3} className="border border-gray-400 px-4 py-3 text-center font-bold text-gray-900">
                    INSTITUTION'S INNOVATION COUNCIL-6.0COUNCIL MEMBERS
                  </th>
                </tr>
                <tr className="bg-[#f5f1e8]">
                  <th className="border border-gray-400 px-4 py-3 text-left font-bold text-gray-900">S.No</th>
                  <th className="border border-gray-400 px-4 py-3 text-left font-bold text-gray-900">Name</th>
                  <th className="border border-gray-400 px-4 py-3 text-left font-bold text-gray-900">Position Assigned</th>
                </tr>
              </thead>
              <tbody>
                <tr>
